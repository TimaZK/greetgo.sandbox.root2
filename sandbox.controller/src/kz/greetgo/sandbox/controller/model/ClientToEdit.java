...
public class ClientToEdit {
  ...
  public ClientToEdit(String id, String firstName, String lastName, String patron, Gender gender,
                      Date birthDay, String charm, Address factAddress, Address regAddress, Phones[] phones) {
    this.id = id;
